...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new CardAdapter(MainActivity.this, cards);
        ...
        listCards.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i){
                    case 0:
                        auxCard = cards.get(0);
                        intent = new Intent(MainActivity.this, InformativoActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_inicio) {
            ...
            Intent intent = new Intent(MainActivity.this, GaleriaImagensActivity.class);
            startActivity(intent);
            finish();
        } else if (id == R.id.nav_galeria_videos) {
            Intent intent = new Intent(MainActivity.this, GaleriaVideosActivity.class);
            startActivity(intent);
            finish();
