...
public class BluetoothProcurarActivity extends AppCompatActivity implements OnBtEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bluetooth_procurar);
        ...
        Button btnProcurar = (Button) findViewById(R.id.btnBluetoothProcurar);
        btnProcurar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                BaseAdapter adapter = new BtAdapter(BluetoothProcurarActivity.this, listaDispositivo);
        ...
        lstBluetooth.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(BluetoothProcurarActivity.this, ProcurarActivity.class);
    ...
    private void iniciarTela() {
        ...
        lstBluetooth = (ListView) findViewById(R.id.lstBluetoothProcurar);
